...
export type SignInFailed = ActionWithPayload<USER_ACTIONS_TYPE.SIGN_IN_FAILED, Error>
...
export type SignOutFailed = ActionWithPayload<USER_ACTIONS_TYPE.SIGN_OUT_FAILED, Error>
...
export const googleSignInStart = withMatcher((): GoogleSignInStart => createAction(USER_ACTIONS_TYPE.GOOGLE_SIGN_IN_START));
...
export const signInSuccess = withMatcher((user: UserData & {id: string}) => createAction(USER_ACTIONS_TYPE.SIGN_IN_SUCCESS, user));

export const signInFailed = withMatcher((error: Error) : SignInFailed => createAction(USER_ACTIONS_TYPE.SIGN_IN_FAILED, error));

export const signUpStart = withMatcher((email: string, password: string, displayName: string) : SignUpStart => createAction(USER_ACTIONS_TYPE.SIGN_UP_START, 
  {
    email,
    password,
    displayName,
...
export const signUpSuccess = withMatcher((user: User, additionalDetails: AdditionalInformation) : SignUpSuccess => createAction(USER_ACTIONS_TYPE.SIGN_UP_SUCCESS, {user, additionalDetails}));
